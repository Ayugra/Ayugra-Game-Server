...
int ServerConfiguration::server_id;
int ServerConfiguration::server_channel_id;
unsigned short ServerConfiguration::server_port;
...
bool ServerConfiguration::load()
{
	return reload();
}

bool ServerConfiguration::reload()
{
	FILE* fp;
#ifdef _WIN32
...
bool ServerConfiguration::isConfigValid(const rapidjson::Document& document)
{
...
bool ServerConfiguration::parseConfig(const rapidjson::Document& document)
{
